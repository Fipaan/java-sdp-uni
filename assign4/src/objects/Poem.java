public class Poem<T extends Document> {
    public T build(T container) {
        return new DocumentBuilder<T>(container)
                .buildAuthor("Manuel Gutiérrez Nájera")
                .buildDate("04 November 2015")
                .buildTitle("I want to die as the day declines...")
                .buildContent(
