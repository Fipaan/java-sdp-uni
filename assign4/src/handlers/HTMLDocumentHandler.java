...
public class HTMLDocumentHandler extends DocumentHandler {
    public HTMLDocumentHandler() {
        super(new HTMLDocument());
    }
    public HTMLDocumentHandler(HTMLDocument doc) {
        super(doc);
    }
    public HTMLDocumentHandler(String str) throws ParseException {
        this();
        this.fromString(str);
    }
    public void fromString(String str) throws ParseException {
        if (!doc.fromString(str)) throw new ParseException("Invalid HTML document", 0);
    }
    public void readFile(String filename) throws IOException, ParseException {
        try {
            ...
            throw new IOException("Couldn't read from HTML file");
        }
    }
    public void writeFile(String filename) throws IOException {
        try {
            ...
            throw new IOException("Couldn't write into HTML file");
        }
    }
}
