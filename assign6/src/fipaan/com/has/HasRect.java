...
public interface HasRect<Self extends HasRect<Self>> extends HasLocation<Self>, HasSize<Self> {
    ...
    // @Override public Self setWidth(int w);
    // @Override public Self setHeight(int h);
    // @Override public Self setX(int x);
    // @Override public Self setY(int y);
    ...
    default Self resetRectBySize(Dimension size) { setLocation(size).setSize(size); return self(); }
